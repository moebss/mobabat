        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 relative w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative hidden lg:block w-full h-full" style={{ perspective: 1000 }}>
              ...
              >
                <div
                  className="absolute inset-0 bg-gradient-to-tl from-emerald-400/20 to-teal-500/20 rounded-full blur-3xl animate-pulse"
                  style={{ transform: "translateZ(-40px)" }}
                />
                <img
                  src={`${import.meta.env.BASE_URL}hero_3d_local.png`}
                  alt="Abstract Hardware Traces"
                  className="relative z-10 w-full h-auto object-contain animate-float"
                  style={{ animationDuration: '6.5s', transform: "translateZ(60px)" }}
                />
              </motion.div>
            </div>
          </div>
